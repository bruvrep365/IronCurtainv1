...
function buildUSSRFocus(): FocusTree {
  return {
    ...
    nodes: [
      ...
      // Historical Stalinist path — economic branch
      { id: 'ssh1', name: 'Stalinist Collectivization', description: 'Forced collectivization of agriculture. GDP +100, Military +5, but Tension +8. Consolidates Stalinist control over the countryside.', category: 'economic', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['s1'], effects: { gdp: 100, military: 5, tension: 8 }, x: 0, y: 4, icon: 'wheat' },
      { id: 'ssh2', name: 'Gulag Labour Economy', description: 'Forced labour drives industrial output. GDP +200, Military +10, Tension +12. Historically accurate expansion of the Gulag system.', category: 'economic', status: 'locked', turnsRequired: 4, turnsRemaining: 4, prerequisites: ['ssh1'], effects: { gdp: 200, military: 10, tension: 12 }, x: 0, y: 5, icon: 'hammer' },
      { id: 'ssh3', name: 'Doctors\' Plot', description: 'Stalin\'s antisemitic show-trials weaken internal opposition. Prestige +20 (fear), Tension +5. Unlocks Iron Curtain decree.', category: 'economic', status: 'locked', turnsRequired: 2, turnsRemaining: 2, prerequisites: ['ssh2'], effects: { prestige: 20, tension: 5 }, x: 0, y: 6, icon: 'skull' },
      // Non-historical Stalinist path — alternate history
      { id: 'snh1', name: 'Stalin Lives On', description: 'NON-HISTORICAL: Stalin survives 1953. The cult of personality reaches absolute heights. Prestige +50, Military +20, but Tension +20.', category: 'economic', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['ssh3'], effects: { prestige: 50, military: 20, tension: 20 }, x: 0, y: 7, icon: 'crown' },
      { id: 'snh2', name: 'Soviet World Manifesto', description: 'NON-HISTORICAL: Stalin proclaims the inevitable global triumph of communism. Prestige +80, GDP +300, Tension +25. Near-total polarisation.', category: 'economic', status: 'locked', turnsRequired: 4, turnsRemaining: 4, prerequisites: ['snh1'], effects: { prestige: 80, gdp: 300, tension: 25 }, x: 0, y: 8, icon: 'globe' },
      ...
      // Historical Stalinist path — military branch
      { id: 'ssm1', name: 'Great Purge (Military)', description: 'Purge of unreliable Red Army officers. Short-term Military -5 but long-term loyalty: Military +25, Prestige +15, Tension +10.', category: 'military', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['s5'], effects: { military: 20, prestige: 15, tension: 10 }, x: 1, y: 4, icon: 'sword' },
      { id: 'ssm2', name: 'Iron Satellites', description: 'Crush dissent in Eastern Europe — Hungary 1956, Czechoslovakia 1968. Military +15, all satellite stability +10. Tension +15.', category: 'military', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['ssm1', 'ssh1'], effects: { military: 15, tension: 15, prestige: 10 }, x: 1, y: 5, icon: 'lock' },
      { id: 'ssm3', name: 'Nuclear Supremacy Doctrine', description: 'Adopt first-strike nuclear doctrine. Nukes +3, Military +20, Tension +20. Frightens the West into concessions.', category: 'military', status: 'locked', turnsRequired: 4, turnsRemaining: 4, prerequisites: ['ssm2'], effects: { nuclearWarheads: 3, military: 20, tension: 20 }, x: 1, y: 6, icon: 'zap' },
      // Non-historical military branch
      { id: 'snm1', name: 'Operation Red Storm', description: 'NON-HISTORICAL: Stalin orders total military mobilisation for a preemptive strike on Western Europe. Military +40, Nukes +2, Tension +30. The world holds its breath.', category: 'military', status: 'locked', turnsRequired: 5, turnsRemaining: 5, prerequisites: ['ssm3', 'snh1'], effects: { military: 40, nuclearWarheads: 2, tension: 30 }, x: 1, y: 7, icon: 'flame' },
      { id: 'snm2', name: 'People\'s Liberation Offensive', description: 'NON-HISTORICAL: Soviet-backed communist uprisings across Western Europe and Asia simultaneously. Prestige +100, Military +30, Tension +25. USSR prestige dominates the world.', category: 'military', status: 'locked', turnsRequired: 5, turnsRemaining: 5, prerequisites: ['snm1', 'snh2'], effects: { prestige: 100, military: 30, tension: 25 }, x: 1, y: 8, icon: 'star' },
      ...
      // Historical Stalinist path — intelligence branch
      { id: 'ssi1', name: 'MGB Secret Police', description: 'The Ministry of State Security blankets the USSR and satellites. Intelligence ops always succeed. Prestige +20, Tension +5.', category: 'intelligence', status: 'locked', turnsRequired: 2, turnsRemaining: 2, prerequisites: ['s9'], effects: { prestige: 20, tension: 5, researchPoints: 15 }, x: 2, y: 4, icon: 'badge' },
      { id: 'ssi2', name: 'Atomic Espionage', description: 'Soviet spies steal US nuclear secrets. Nukes +2, Research +30, Tension -5 (rivals fear mutual destruction).', category: 'intelligence', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['ssi1'], effects: { nuclearWarheads: 2, researchPoints: 30, tension: -5 }, x: 2, y: 5, icon: 'atom' },
      { id: 'ssi3', name: 'The Rosenberg Network', description: 'Deep-cover agents inside US weapons programs. Nukes +1, Research +50, Prestige +25. Decisive intelligence advantage.', category: 'intelligence', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['ssi2'], effects: { nuclearWarheads: 1, researchPoints: 50, prestige: 25 }, x: 2, y: 6, icon: 'network' },
      // Non-historical intelligence branch — leads to secret victory
      { id: 'sni1', name: 'Global Communist Underground', description: 'NON-HISTORICAL: KGB-directed worldwide communist cells ready to seize power simultaneously. Prestige +60, Tension +15, Research +40.', category: 'intelligence', status: 'locked', turnsRequired: 4, turnsRemaining: 4, prerequisites: ['ssi3', 'snh1'], effects: { prestige: 60, tension: 15, researchPoints: 40 }, x: 2, y: 7, icon: 'network' },
      { id: 'sni2', name: 'STALINIST WORLD ORDER', description: 'NON-HISTORICAL VICTORY PATH: Stalinist world revolution triggers simultaneous communist coups across the West. Prestige +150, GDP +500, Military +50. If completed, the USSR wins by ideological dominance.', category: 'intelligence', status: 'locked', turnsRequired: 6, turnsRemaining: 6, prerequisites: ['sni1', 'snm2', 'snh2'], effects: { prestige: 150, gdp: 500, military: 50, tension: -20 }, x: 2, y: 8, icon: 'star' },
    ]
  };
}
