...
function buildUSSRFocus(): FocusTree {
  return {
    ...
    nodes: [
      ...
      { id: 'sp_s6', name: 'Consolidation og Marxist-Leninist thought', description: 'Crush dissent across Eastern Europe. Military +15, Tension +15, Prestige +10.', category: 'political', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['sp_s4'], effects: { military: 15, tension: 15, prestige: 10 }, x: 1, y: 4, icon: 'lock' },
