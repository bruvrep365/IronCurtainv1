...
function buildUSSRFocus(): FocusTree {
  return {
    ...
    nodes: [
      // === ECONOMIC ===
      { id: 's1', name: 'Five-Year Plan', description: 'Centralized industrial expansion. GDP +150, Production +25.', category: 'economic', status: 'available', turnsRequired: 2, turnsRemaining: 2, prerequisites: [], effects: { gdp: 150, researchPoints: 25 }, x: 0, y: 0, icon: 'factory' },
      { id: 's2', name: 'COMECON', description: 'Economic integration of Eastern Bloc. All Warsaw economies +10.', category: 'economic', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['s1'], effects: { gdp: 200, prestige: 15 }, x: 0, y: 1, icon: 'handshake' },
      { id: 's3', name: 'Soviet Oil Exports', description: 'Fuel the global economy. Income +250, but Tension +10.', category: 'economic', status: 'locked', turnsRequired: 2, turnsRemaining: 2, prerequisites: ['s1'], effects: { gdp: 250, tension: 10 }, x: 0, y: 2, icon: 'fuel' },
      { id: 's4', name: 'Moscow Financial Center', description: 'The Ruble challenges the dollar. Income +350, Prestige +35.', category: 'economic', status: 'locked', turnsRequired: 4, turnsRemaining: 4, prerequisites: ['s2', 's3'], effects: { gdp: 350, prestige: 35 }, x: 0, y: 3, icon: 'landmark' },
      // === MILITARY ===
      { id: 's5', name: 'Red Army Expansion', description: 'Massive conscription. Military +15, unlock Armor.', category: 'military', status: 'available', turnsRequired: 2, turnsRemaining: 2, prerequisites: [], effects: { unlockUnit: 'armor', military: 15 }, x: 1, y: 0, icon: 'shield' },
      { id: 's6', name: 'Warsaw Pact', description: 'Military alliance with Eastern Bloc. Allies gain +5 units.', category: 'military', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['s5'], effects: { prestige: 25, tension: 5 }, x: 1, y: 1, icon: 'users' },
      { id: 's7', name: 'Tank Divisions', description: 'T-54 mass production. Armor cost -20%, unlock Air.', category: 'military', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['s5'], effects: { unlockUnit: 'air', unitDiscount: 20 }, x: 1, y: 2, icon: 'truck' },
      { id: 's8', name: 'Vietnam Doctrine', description: 'Guerrilla warfare expertise. +20 military, proxy wars cheaper.', category: 'military', status: 'locked', turnsRequired: 4, turnsRemaining: 4, prerequisites: ['s6', 's7'], effects: { military: 20, unitDiscount: 20 }, x: 1, y: 3, icon: 'plane' },
      // === INTELLIGENCE ===
      { id: 's9', name: 'KGB Operations', description: 'Establish intelligence network. Tension -10, Prestige +15.', category: 'intelligence', status: 'available', turnsRequired: 1, turnsRemaining: 1, prerequisites: [], effects: { prestige: 15, tension: -10 }, x: 2, y: 0, icon: 'eye' },
      ...
      { id: 's11', name: 'Sputnik Program', description: 'First satellite launch. Prestige +40, Tension -10.', category: 'intelligence', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['s9'], effects: { prestige: 40, tension: -10 }, x: 2, y: 2, icon: 'rocket' },
      ...
      // Historical branch
      { id: 'sp_s1', name: 'Cult of Personality', description: 'STALINIST: Elevate Stalin to divine status. Prestige +30, Tension +8. The party is purged of moderates.', category: 'political', status: 'locked', turnsRequired: 2, turnsRemaining: 2, prerequisites: ['sp0'], effects: { prestige: 30, tension: 8 }, x: 0, y: 1, icon: 'crown' },
      { id: 'sp_s2', name: 'Stalinist Collectivization', description: 'STALINIST: Forced collectivization of agriculture. GDP +100, Military +5, Tension +8.', category: 'political', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['sp_s1'], effects: { gdp: 100, military: 5, tension: 8 }, x: 0, y: 2, icon: 'wheat' },
      { id: 'sp_s3', name: 'Gulag Labour Economy', description: 'STALINIST: Forced labour drives industrial output. GDP +200, Military +10, Tension +12.', category: 'political', status: 'locked', turnsRequired: 4, turnsRemaining: 4, prerequisites: ['sp_s2'], effects: { gdp: 200, military: 10, tension: 12 }, x: 0, y: 3, icon: 'hammer' },
      { id: 'sp_s4', name: 'Great Purge', description: 'STALINIST: Purge unreliable officers and party members. Military +20, Prestige +15, Tension +10.', category: 'political', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['sp_s2'], effects: { military: 20, prestige: 15, tension: 10 }, x: 1, y: 3, icon: 'sword' },
      { id: 'sp_s5', name: 'Doctors\' Plot', description: 'STALINIST: Show-trials crush internal opposition. Prestige +20, Tension +5. Unlocks non-historical branch.', category: 'political', status: 'locked', turnsRequired: 2, turnsRemaining: 2, prerequisites: ['sp_s3', 'sp_s4'], effects: { prestige: 20, tension: 5 }, x: 0, y: 4, icon: 'skull' },
      { id: 'sp_s6', name: 'Iron Satellites', description: 'STALINIST: Crush dissent across Eastern Europe. Military +15, Tension +15, Prestige +10.', category: 'political', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['sp_s4'], effects: { military: 15, tension: 15, prestige: 10 }, x: 1, y: 4, icon: 'lock' },
      // Non-historical escalation
      { id: 'sp_s7', name: 'Stalin Lives On', description: 'NON-HISTORICAL: Stalin survives 1953 and tightens his grip. Prestige +50, Military +20, Tension +20.', category: 'political', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['sp_s5'], effects: { prestige: 50, military: 20, tension: 20 }, x: 0, y: 5, icon: 'crown' },
      { id: 'sp_s8', name: 'Nuclear Supremacy Doctrine', description: 'NON-HISTORICAL: First-strike nuclear doctrine. Nukes +3, Military +20, Tension +20.', category: 'political', status: 'locked', turnsRequired: 4, turnsRemaining: 4, prerequisites: ['sp_s6', 'sp_s7'], effects: { nuclearWarheads: 3, military: 20, tension: 20 }, x: 1, y: 5, icon: 'zap' },
      { id: 'sp_s9', name: 'Soviet World Manifesto', description: 'NON-HISTORICAL: Proclaim inevitable global communist triumph. Prestige +80, GDP +300, Tension +25.', category: 'political', status: 'locked', turnsRequired: 4, turnsRemaining: 4, prerequisites: ['sp_s7'], effects: { prestige: 80, gdp: 300, tension: 25 }, x: 0, y: 6, icon: 'globe' },
      { id: 'sp_s10', name: 'Operation Red Storm', description: 'NON-HISTORICAL: Total mobilisation for preemptive strike. Military +40, Nukes +2, Tension +30.', category: 'political', status: 'locked', turnsRequired: 5, turnsRemaining: 5, prerequisites: ['sp_s8', 'sp_s9'], effects: { military: 40, nuclearWarheads: 2, tension: 30 }, x: 0, y: 7, icon: 'flame' },
      { id: 'sp_s11', name: 'STALINIST WORLD ORDER', description: 'NON-HISTORICAL VICTORY: Simultaneous communist coups sweep the West. Prestige +150, GDP +500, Military +50. Completing this wins the game for the USSR.', category: 'political', status: 'locked', turnsRequired: 6, turnsRemaining: 6, prerequisites: ['sp_s10'], effects: { prestige: 150, gdp: 500, military: 50, tension: -20 }, x: 0, y: 8, icon: 'star' },
      // === POLITICAL — REFORMIST PATH ===
      { id: 'sp_r1', name: 'De-Stalinization', description: 'REFORMIST: Khrushchev\'s secret speech denounces Stalin\'s crimes. Prestige +20, Tension -15. The thaw begins.', category: 'political', status: 'locked', turnsRequired: 2, turnsRemaining: 2, prerequisites: ['sp0'], effects: { prestige: 20, tension: -15 }, x: 2, y: 1, icon: 'sun' },
      { id: 'sp_r2', name: 'New Economic Policy', description: 'REFORMIST: Liberalise agriculture and small enterprise. GDP +180, Prestige +15, Tension -5.', category: 'political', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['sp_r1'], effects: { gdp: 180, prestige: 15, tension: -5 }, x: 2, y: 2, icon: 'trending-up' },
      { id: 'sp_r3', name: 'Cultural Thaw', description: 'REFORMIST: Loosen artistic censorship — Pasternak, Solzhenitsyn. Prestige +25, Research +20, Tension -8.', category: 'political', status: 'locked', turnsRequired: 2, turnsRemaining: 2, prerequisites: ['sp_r1'], effects: { prestige: 25, researchPoints: 20, tension: -8 }, x: 3, y: 2, icon: 'book' },
      ...
      { id: 'sp_r5', name: 'Glasnost', description: 'REFORMIST: Policy of openness and transparency. Prestige +30, Research +30, GDP +100, Tension -10.', category: 'political', status: 'locked', turnsRequired: 3, turnsRemaining: 3, prerequisites: ['sp_r4'], effects: { prestige: 30, researchPoints: 30, gdp: 100, tension: -10 }, x: 2, y: 4, icon: 'eye' },
      { id: 'sp_r6', name: 'Perestroika', description: 'REFORMIST: Restructure the Soviet economy. GDP +250, Prestige +25, Research +40, Tension -10.', category: 'political', status: 'locked', turnsRequired: 4, turnsRemaining: 4, prerequisites: ['sp_r5'], effects: { gdp: 250, prestige: 25, researchPoints: 40, tension: -10 }, x: 3, y: 4, icon: 'settings' },
      ...
      { id: 'sp_r8', name: 'Soviet Commonwealth', description: 'REFORMIST: Voluntary federation of Soviet republics — a transformed, stable USSR. GDP +300, Prestige +50, Tension -20.', category: 'political', status: 'locked', turnsRequired: 4, turnsRemaining: 4, prerequisites: ['sp_r6', 'sp_r7'], effects: { gdp: 300, prestige: 50, tension: -20 }, x: 2, y: 6, icon: 'globe' },
      { id: 'sp_r9', name: 'NEW SOVIET CENTURY', description: 'REFORMIST VICTORY: A reformed, stable Soviet state leads the world through diplomacy and economic might. Prestige +120, GDP +400, Tension -30. Completing this wins the game for the USSR by soft power.', category: 'political', status: 'locked', turnsRequired: 5, turnsRemaining: 5, prerequisites: ['sp_r8'], effects: { prestige: 120, gdp: 400, tension: -30 }, x: 2, y: 7, icon: 'star' },
    ]
  };
}
