...
function buildUSSRFocus(): FocusTree {
  return {
    ...
    nodes: [
      ...
      // Historical branch
      { id: 'sp_s1', name: 'Cult of Personality', description: 'Elevate Stalin to divine status. Prestige +30, Tension +8. The party is purged of moderates.', category: 'political', status: 'locked', turnsRequired: 8, turnsRemaining: 8, prerequisites: ['sp0'], effects: { prestige: 30, tension: 8 }, x: 20, y: 1, icon: 'crown' },
